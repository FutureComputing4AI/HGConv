...
class Network(nn.Module):
    ...
    def __call__(self, en_in, training: bool = False):
        ...
        for i in range(self.n_layer):
            ...
            cf = self.param(f'cf_{i}', jax.random.normal, (1, 64, self.embed_size))
...
if __name__ == '__main__':
    ...
    train(batch_size=20, vocab_size=20, max_seq_len=2000, embed_size=128, n_layer=6,
          output_size=10, dropout_rate=0.0, lr=0.01, epochs=40)
